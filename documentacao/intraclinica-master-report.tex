...
\begin{itemize}
    ...
    \item \textbf{Isolamento Multi-Tenancy (RLS):} Utilização de \textit{Row Level Security} nativo do Postgres para garantir o isolamento absoluto dos dados entre diferentes unidades. Um médico só acessa dados onde o identificador da clínica coincide com seu perfil autorizado.
...
\vfill
\centering
\textit{Documento gerado e verificado pela arquitetura Axio Nexus v3.3.} 🧪🧬🏥
\end{document}
